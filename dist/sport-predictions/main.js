...
var AppComponent = /** @class */ (function () {
        ...
        setInterval(function () {
            _this.http.get('http://localhost:9000')
                ...
                for (var index = 0; index < _this.team1Sentiment.length - 1; index++) {
                    _this.team1Sentiment[index] = _this.team1Sentiment[index + 1];
                }
                _this.team1Sentiment[_this.team1Sentiment.length - 1] = data.data.team1Sentiment;
                _this.team1AverageSentiment = Math.round(data.data.team1AverageSentiment * 100) / 100;
                for (var index = 0; index < _this.labels.length - 1; index++) {
                    _this.labels[index] = _this.labels[index + 1];
                }
                _this.labels[_this.labels.length - 1] = new Date().getMinutes() + ':' + new Date().getSeconds();
                for (var index = 0; index < _this.team2Sentiment.length - 1; index++) {
                    _this.team2Sentiment[index] = _this.team2Sentiment[index + 1];
                }
                _this.team2Sentiment[_this.team2Sentiment.length - 1] = data.data.team2Sentiment;
                _this.team2AverageSentiment = Math.round(data.data.team2AverageSentiment * 100) / 100;
    ...
    ], AppComponent.prototype, "htmlRef", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('chart2'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], AppComponent.prototype, "htmlRef2", void 0);
